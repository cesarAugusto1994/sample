 ...
 */
class Colecao extends \Api\Entities\Colecao implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Api\\Entities\\Colecao' . "\0" . 'id', '' . "\0" . 'Api\\Entities\\Colecao' . "\0" . 'nome', '' . "\0" . 'Api\\Entities\\Colecao' . "\0" . 'descricao', '' . "\0" . 'Api\\Entities\\Colecao' . "\0" . 'categoria'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Colecao $proxy) {
