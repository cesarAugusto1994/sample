 ...
 */
class Musica extends \Api\Entities\Musica implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Api\\Entities\\Musica' . "\0" . 'id', '' . "\0" . 'Api\\Entities\\Musica' . "\0" . 'nome', '' . "\0" . 'Api\\Entities\\Musica' . "\0" . 'numero', '' . "\0" . 'Api\\Entities\\Musica' . "\0" . 'letra', '' . "\0" . 'Api\\Entities\\Musica' . "\0" . 'categoria'];
        }
